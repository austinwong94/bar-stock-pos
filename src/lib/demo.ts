...
export const demoProducts: ProductWithStock[] = [
  { id: '20000000-0000-0000-0000-000000000001', name: '1602 Lager', category_id: beer.id, price_per_unit: 12, cost_per_unit: 7, carton_size: 24, low_stock_threshold: 12, active: true, image_url: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), categories: beer, inventory_balances: { quantity_on_hand: 72 } },
  { id: '20000000-0000-0000-0000-000000000002', name: '1602 Pale Ale', category_id: beer.id, price_per_unit: 14, cost_per_unit: 8, carton_size: 24, low_stock_threshold: 12, active: true, image_url: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), categories: beer, inventory_balances: { quantity_on_hand: 20 } },
  { id: '20000000-0000-0000-0000-000000000003', name: '1602 Extra Dark', category_id: beer.id, price_per_unit: 16, cost_per_unit: 9, carton_size: 24, low_stock_threshold: 12, active: true, image_url: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), categories: beer, inventory_balances: { quantity_on_hand: 8 } },
  { id: '20000000-0000-0000-0000-000000000004', name: 'Coke', category_id: softDrink.id, price_per_unit: 5, cost_per_unit: 2.2, carton_size: 24, low_stock_threshold: 12, active: true, image_url: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), categories: softDrink, inventory_balances: { quantity_on_hand: 48 } },
  { id: '20000000-0000-0000-0000-000000000005', name: '7Up', category_id: softDrink.id, price_per_unit: 5, cost_per_unit: 2.2, carton_size: 24, low_stock_threshold: 12, active: true, image_url: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), categories: softDrink, inventory_balances: { quantity_on_hand: 36 } },
  { id: '20000000-0000-0000-0000-000000000006', name: 'Fanta', category_id: softDrink.id, price_per_unit: 5, cost_per_unit: 2.2, carton_size: 24, low_stock_threshold: 12, active: true, image_url: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), categories: softDrink, inventory_balances: { quantity_on_hand: 24 } },
];
