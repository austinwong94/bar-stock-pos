...
export const buttonClass =
  'inline-flex min-h-10 items-center justify-center gap-2 rounded-lg border border-accent bg-accent px-3.5 py-2 text-center text-sm font-semibold leading-tight text-white transition hover:bg-lagoon hover:border-lagoon disabled:cursor-not-allowed disabled:opacity-45 sm:min-h-11';
